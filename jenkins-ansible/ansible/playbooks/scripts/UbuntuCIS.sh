...
# PasswordAuthentication yes # Uncomment if you want to allow password authentication/SFTP
ChallengeResponseAuthentication no
UsePAM yes
AuthenticationMethods publickey # Comment this line if you want to allow password authentication
